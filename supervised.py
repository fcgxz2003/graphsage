...
if __name__ == "__main__":
    ...
    graphsage = GraphSageSupervised(dim=len(raw_features[0]), sample=SAMPLE_SIZES, num_classes=1)
    ...
    for inputs, inputs_labels in islice(minibatch_generator, 0, TRAINING_STEPS):
        ...
        # # graphsage 初始化，不将特征传入，而是特征在外部解析。
        # graphsage = GraphSageSupervised(raw_features, SAMPLE_SIZES)
